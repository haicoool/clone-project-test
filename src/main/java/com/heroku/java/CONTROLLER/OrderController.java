...
public class OrderController {
    ...
    @GetMapping("/catalogue")
          ...
          public String orderproduct(HttpSession session,Model model,@RequestParam("proprice") int proprice,@RequestParam("quantity")int orderdetailqty,@RequestParam("proid") int productid,@RequestParam("proname") String proname){
